...
<div class="container-fluid mb-5">
    <div class="row border-top px-xl-5">
        <jsp:include page="/users/includes/collsape.jsp"></jsp:include>
        <div class="col-lg-9">
            <jsp:include page="/users/includes/navbar.jsp"></jsp:include>
            <div id="header-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active" style="height: 410px;">
                        <img class="img-fluid" src="/users/img/carousel-4.jpeg" alt="Image">
    ...
    <div class="row px-xl-5 pb-3">
        <div class="col-lg-4 col-md-6 pb-1">
            <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                ...
                <a href="" class="cat-img position-relative overflow-hidden mb-3">
                    <img class="img-fluid" src="/users/img/cat-1.png" alt="">
                </a>
        ...
        <div class="col-lg-4 col-md-6 pb-1">
            <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                <p class="text-right">15 Products</p>
                <a href="" class="cat-img position-relative overflow-hidden mb-3">
                    <img class="img-fluid" src="/users/img/cat-2.png" alt="">
                </a>
                <h5 class="font-weight-semi-bold m-0">Socks</h5>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 pb-1">
            <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                <p class="text-right">15 Products</p>
                <a href="" class="cat-img position-relative overflow-hidden mb-3">
                    <img class="img-fluid ml-4" src="/users/img/jordan7.png" style="height: 366px;" alt="">
                </a>
    ...
    <div class="row px-xl-5">
        <div class="col-md-6 pb-4">
            <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-5 px-5">
                <img src="/users/img/jordan3.jpg" alt="">
                <div class="position-relative" style="z-index: 1;">
                    <h5 class="text-uppercase text-primary mb-3">20% off the all order</h5>
                    <h1 class="mb-4 font-weight-semi-bold">Spring Collection</h1>
                    <a href="/products" class="btn btn-outline-primary py-md-2 px-md-3">Shop Now</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 pb-4">
            <div class="position-relative bg-secondary text-center text-md-left text-white mb-2 py-5 px-5">
                <img src="/users/img/jordan6.jpg" alt="">
                <div class="position-relative" style="z-index: 1;">
                    <h5 class="text-uppercase text-primary mb-3">20% off the all order</h5>
            ...
            <div class="card product-item border-0 mb-4">
                ...
                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                    ...
                    <div class="d-flex justify-content-center">
                        <h6>$<%=product.getPrice()%></h6><h6 class="text-muted ml-2"><del>$<%=product.getPrice()%></del></h6>
                    </div>
                </div>
